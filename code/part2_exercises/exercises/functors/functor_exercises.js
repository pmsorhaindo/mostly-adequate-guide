...
var ex3 = compose(_.map(_.head), safeProp('name'));
...
var ex4 = compose(Maybe.of, parseInt);
...
var ex5 = compose(_.map(_.toUpper), _.map(_.prop('title')), getPost);
...
var ex6 = compose(either(Left.of, compose(Right.of, showWelcome)), checkActive);
